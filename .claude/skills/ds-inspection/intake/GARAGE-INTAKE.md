...
|---|---|---|
| Design library | live / export / screenshot / interview | <e.g. "Figma bridge call returned the real library"; name the bridge and whether you can sweep the whole file or only linked nodes> |
